    ...
    function setChatUiState(allowed, statusText, showCall = false) {
      ...
      if (msgs && !allowed && !document.getElementById('chatLockNotice')) {
        msgs.insertAdjacentHTML('afterbegin', `
          <div id="chatLockNotice" style="margin:10px 0 6px;padding:12px 14px;border-radius:14px;background:#f9efcf;border:1px solid #e8c86b;color:#7a5600;font-size:.82rem;line-height:1.75">
